...
public class HoleShort extends Hole {
    ...
    protected void setupBody(float x, float y) {
        ...
        line.set(new Vector2(-30 / Zombie.PPM, 0 / Zombie.PPM), new Vector2(30 / Zombie.PPM, 0 / Zombie.PPM));
        ...
        line.set(new Vector2(80 / Zombie.PPM, 10 / Zombie.PPM), new Vector2(100 / Zombie.PPM, 10 / Zombie.PPM));
