...
public class TextureHolder {
    ...
    public TextureHolder(Texture MENU_BACKGROUND_BOT, Texture MENU_BACKGROUND_TOP, Texture MENU_PARALLAX_FOG, Texture MENU_PLAY, Texture MENU_OPTIONS, Texture MENU_ABOUT) {
