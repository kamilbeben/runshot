...
public class TextureHolder {
    ...
    public Texture GAME_EXTRAS_PARALLAX_MOUNTAINS;
    ...
    public TextureHolder(Texture HUD_AMMO_BACKGROUND, Texture HUD_AMMO_ON, Texture HUD_AMMO_OFF, Texture GAME_EXTRAS_AMMOPACK, Texture GAME_EXTRAS_GRASS_ANIMATION, Texture GAME_EXTRAS_FIREFLY_GREEN, Texture GAME_EXTRAS_FIREFLY_BLUE, Texture GAME_EXTRAS_FIREFLY_TRANSPARENT, Texture GAME_EXTRAS_PALETTE, Texture GAME_EXTRAS_BACKGROUND, Texture GAME_EXTRAS_PARALLAX_MOUNTAINS, Texture GAME_ENEMY_CAR, Texture GAME_ENEMY_MONKEY, Texture GAME_ENEMY_WALKER, Texture GAME_PLAYER, Texture GAME_PLAYER_EXTENDED, Texture GAME_OBSTACLE_HOLE_LONG, Texture GAME_OBSTACLE_HOLE_SHORT, Texture GAME_OBSTACLE_ISLAND_LONG, Texture GAME_OBSTACLE_ISLAND_SHORT) {
        ...
        this.GAME_EXTRAS_PARALLAX_MOUNTAINS = GAME_EXTRAS_PARALLAX_MOUNTAINS;
